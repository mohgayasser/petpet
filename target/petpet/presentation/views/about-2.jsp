                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="/petpet/presentation/views/wishlist.jsp"><i class="icon-heart-o"></i>Wishlist <span>(3)</span></a></li>
                                    <li><a href="/petpet/presentation/views/about-2.jsp">About Us</a></li>
                                    <li><a href="/petpet/presentation/views/contact.jsp">Contact Us</a></li>
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                <li class="megamenu-container active">
                                    <a href="/petpet/presentation/views/index-5.jsp" class="sf-with-ul">Home</a>
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="/petpet/presentation/assets/images/logo.png" class="footer-logo" alt="Footer Logo" width="105" height="25">

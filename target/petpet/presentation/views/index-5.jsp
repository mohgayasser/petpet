            ...
            <div class="header-middle sticky-header">
                <div class="container-fluid">
                    <div class="header-left">
                        ...
                        <a href="/petpet/presentation/views/index-5.jsp" class="logo">
                            <img src="/petpet/presentation/assets/images/demos/demo-5/logo.png" alt="Molla Logo" width="105" height="25">
                        </a>
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    <a href="/petpet/presentation/views/category-fullwidth.jsp" class="sf-with-ul">Shop</a>
                                        ...
                                        <div class="row no-gutters">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="category-market.jsp"><span>Shop Market<span class="tip tip-new">New</span></span></a></li>
                                                            </ul>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <ul>
                                                                <li><a href="/petpet/presentation/views/product-category-fullwidth.jsp"><span>Product Category Fullwidth<span class="tip tip-new">New</span></span></a></li>
                                                            </ul>
                                                            <div class="menu-title">Shop Pages</div><!-- End .menu-title -->
                                                            <ul>
                                                                <li><a href="/petpet/presentation/views/cart.jsp">Cart</a></li>
                                                                <li><a href="/petpet/presentation/views/checkout.jsp">Checkout</a></li>
                                                                <li><a href="/petpet/presentation/views/wishlist.jsp">Wishlist</a></li>
                                                                <li><a href="/petpet/presentation/views/dashboard.jsp">My Account</a></li>
                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="/petpet/presentation/views/category-fullwidth.jsp" class="banner banner-menu">
                                                        <img src="/petpet/presentation/assets/images/menu/banner-1.jpg" alt="Banner">
                                ...
                                <li>
                                    <a href="/petpet/presentation/views/product.jsp" class="sf-with-ul">Product</a>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/petpet/presentation/views/about-2.jsp" class="sf-with-ul">About</a>
                                        </li>
                                        <li>
                                            <a href="/petpet/presentation/views/contact-2.jsp" class="sf-with-ul">Contact</a>

                                            
                                        </li>
                                        <li><a href="/petpet/presentation/views/login.jsp">Login</a></li>
                                        <li><a href="/petpet/presentation/views/faq.jsp">FAQs</a></li>
                                        <li><a href="/petpet/presentation/views/404.html">Error 404</a></li>
                                        <li><a href="/petpet/presentation/views/coming-soon.jsp">Coming Soon</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="header-right">
                        ...
                        <a href="/petpet/presentation/views/wishlist.jsp" class="wishlist-link">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="/petpet/presentation/views/product.jsp">Beige knitted elastic runner shoes</a>
                                            </h4>
                                    ...
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="/petpet/presentation/views/product.jsp">Blue utility pinafore denim dress</a>
                                            </h4>
                                        ...
                                        <figure class="product-image-container">
                                            <a href="/petpet/presentation/views/product.jsp" class="product-image">
                                ...
                                <div class="dropdown-cart-action">
                                    <a href="/petpet/presentation/views/cart.jsp" class="btn btn-primary">View Cart</a>
                                    <a href="/petpet/presentation/views/checkout.jsp" class="btn btn-outline-primary-2"><span>Checkout</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .dropdown-cart-total -->
        ...
        <main class="main">
            <div class="intro-slider-container mb-0">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{"nav": false, "dots": false}'>
                    <div class="intro-slide" style="background-image: url(/petpet/presentation/views/assets/images/demos/demo-5/slider/slide-1.jpg);">
                        <div class="container intro-content text-center">
                            ...
                            <a href="/petpet/presentation/views/category.jsp" class="btn btn-primary">Discover NOW</a>
                        </div><!-- End .intro-content -->
                    </div><!-- End .intro-slide -->

                    <div class="intro-slide" style="background-image: url(/petpet/presentation/views/assets/images/demos/demo-5/slider/slide-2.jpg);">
                        <div class="container intro-content text-center">
                            ...
                            <a href="/petpet/presentation/views/category.jsp" class="btn btn-primary">Shop NOW</a>
                        </div><!-- End .intro-content -->
                    </div><!-- End .intro-slide -->
            ...
            <div class="brands-border owl-carousel owl-simple mb-5" data-toggle="owl" 
                ...
                <a href="#" class="brand">
                    <img src="/petpet/presentation/views/assets/images/brands/1.png" alt="Brand Name">
                </a>

                <a href="#" class="brand">
                    <img src="/petpet/presentation/views/assets/images/brands/2.png" alt="Brand Name">
                </a>

                <a href="#" class="brand">
                    <img src="/petpet/presentation/views/assets/images/brands/3.png" alt="Brand Name">
                </a>

                <a href="#" class="brand">
                    <img src="/petpet/presentation/views/assets/images/brands/4.png" alt="Brand Name">
                </a>

                <a href="#" class="brand">
                    <img src="/petpet/presentation/views/assets/images/brands/5.png" alt="Brand Name">
                </a>

                <a href="#" class="brand">
                    <img src="/petpet/presentation/views/assets/images/brands/6.png" alt="Brand Name">
                </a>

                <a href="#" class="brand">
                    <img src="/petpet/presentation/views/assets/images/brands/7.png" alt="Brand Name">
                </a>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="banner banner-border">
                                <a href="#">
                                    <img src="/petpet/presentation/views/assets/images/demos/demo-5/banners/banner-1.jpg" alt="Banner">
                                </a>
                        ...
                        <div class="col-md-6">
                            <div class="banner banner-border-hover">
                                <a href="#">
                                    <img src="/petpet/presentation/views/assets/images/demos/demo-5/banners/banner-2.jpg" alt="Banner">
                                </a>
                            ...
                            <div class="banner banner-border-hover">
                                <a href="#">
                                    <img src="/petpet/presentation/views/assets/images/demos/demo-5/banners/banner-3.jpg" alt="Banner">
                                </a>
                    ...
                    <div class="tab-pane p-0 fade show active" id="trendy-all-tab" role="tabpanel" aria-labelledby="trendy-all-link">
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="/petpet/presentation/views/product.jsp">
                                        <img src="/petpet/presentation/views/assets/images/demos/demo-5/products/product-1-1.jpg" alt="Product image" class="product-image">
                                        <img src="/petpet/presentation/views/assets/images/demos/demo-5/products/product-1-2.jpg" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="/petpet/presentation/views/product.jsp">Vest dress</a></h3><!-- End .product-title -->
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="/petpet/presentation/views/product.jsp">
                                        <img src="/petpet/presentation/views/assets/images/demos/demo-5/products/product-2-1.jpg" alt="Product image" class="product-image">
                                        <img src="/petpet/presentation/views/assets/images/demos/demo-5/products/product-2-2.jpg" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="/petpet/presentation/views/product.jsp">Dress with a belt</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $29.99
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.jsp">Sandals</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.jsp">Bucket bag</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $17.99
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.jsp">Vest dress</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $9.99
                                    </div><!-- End .product-price -->
                                                ...
                                                <div class="products">
                                                    <div class="col-6">
                                                        <div class="product product-2 text-center">
                                                            ...
                                                            <div class="product-body">
                                                                <h3 class="product-title"><a href="product.jsp">Rib-knit cardigan</a></h3><!-- End .product-title -->
                                                                <div class="product-price">
                                                                    $24.99
                                                                </div><!-- End .product-price -->
                                                            </div><!-- End .product-body -->
                                                    ...
                                                    <div class="col-6">
                                                        <div class="product product-2 text-center">
                                                            ...
                                                            <div class="product-body">
                                                                <h3 class="product-title"><a href="product.jsp">Linen-blend trousers</a></h3><!-- End .product-title -->
                                                                <div class="product-price">
                                                                    $19.99
                                                                </div><!-- End .product-price -->
                                                            </div><!-- End .product-body -->
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.jsp">Linen-blend dress</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $60.00
                                            </div><!-- End .product-price -->
                                            <div class="product-nav product-nav-dots">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.jsp">Sandals with lacing</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.jsp">Paper bag trousers</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $60.00
                                            </div><!-- End .product-price -->
                                            <div class="product-nav product-nav-dots">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.jsp">Paper straw shopper</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $398.00
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.jsp">Silk-blend kaftan</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                Now $370.00
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.jsp">Linen-blend jumpsuit</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $595.00
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="/petpet/presentation/assets/images/demos/demo-5/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
                        ...
                        <div class="col-sm-4 col-lg-2">
                            <div class="widget">
                                ...
                                <ul class="widget-list">
                                    <li><a href="/petpet/presentation/views/login.jsp">Sign In</a></li>
                                    <li><a href="/petpet/presentation/views/cart.jsp">View Cart</a></li>
                                    <li><a href="/petpet/presentation/views/wishlist.jsp">My Wishlist</a></li>
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <li>
                        <a href="/petpet/presentation/views/category-fullwidth.jsp">Shop</a>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="/petpet/presentation/views/about-2.jsp">About</a>
                            </li>
                            <li>
                                <a href="/petpet/presentation/views/contact-2.jsp">Contact</a>
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="/petpet/presentation/assets/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60" height="15">
